        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg max-w-4xl mx-auto text-teal-700">
              At Himalaya Plast, we embrace sustainability through innovative
              and responsible manufacturing practices. Our mission is to deliver
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="mt-6">
              ...
              <ul className="list-disc list-inside text-teal-700 space-y-2">
                <li>
                  <strong>Versatile & Flexible:</strong> Adaptable to a variety
                  of applications.
                </li>
                <li>
                ...
                <li>
                  <strong>Flame Retardant & Chemical Resistant:</strong>{" "}
                  Enhanced protection for various environments.
                </li>
                <li>
                  <strong>Aesthetic Flexibility:</strong> Available in
                  transparent and colored forms.
                </li>
              </ul>
            </div>
